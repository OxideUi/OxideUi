...
Portions of this project are derived from WarpUI by Denver Technologies, Inc.
Original source: https://github.com/warpdotdev/warp
...
`crates/strato-ui-core` and `crates/strato-ui-renderer`. It is excluded
