...
- [ ] 3. **Expand into animation, batching, and advanced layout**
- [ ] 4. **Introduce world‑space rendering (2.5D, then 3D)**
- [ ] 5. **Layer physics, scripting, and plugins only when justified**
