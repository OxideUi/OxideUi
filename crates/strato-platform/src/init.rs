//! Granular initialization system for StratoUI
//!
...
/// Configuration for StratoUI initialization
#[derive(Debug, Clone)]
...
impl InitBuilder {
    ...
    pub fn init_core(&mut self) -> Result<&mut Self> {
        ...
        if self.config.enable_logging {
            strato_core::strato_trace!(strato_core::logging::LogCategory::Core, "Core initialized");
        }
