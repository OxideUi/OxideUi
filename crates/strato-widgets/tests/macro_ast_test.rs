...
fn test_view_macro_ast_generation() {
    ...
    let expected = UiNode::Widget(WidgetNode {
        ...
        props: vec![("padding".to_string(), PropValue::Float(20.0))],
        children: vec![UiNode::Widget(WidgetNode {
            name: "Text".to_string(),
            props: vec![(
                "text".to_string(),
                PropValue::String("Snapshot".to_string()),
            )],
            children: vec![],
        })],
    });
...
fn test_view_macro_nested() {
    ...
    match node {
        UiNode::Widget(n) => {
            ...
            assert!(n
                .props
                .contains(&("spacing".to_string(), PropValue::Float(10.0))));
            ...
            if let UiNode::Widget(t1) = &n.children[0] {
                ...
                assert!(t1
                    .props
                    .contains(&("text".to_string(), PropValue::String("A".to_string()))));
            } else {
                panic!("child 0 not widget")
            }
            ...
            if let UiNode::Widget(t2) = &n.children[1] {
                ...
                assert!(t2
                    .props
                    .contains(&("text".to_string(), PropValue::String("B".to_string()))));
            } else {
                panic!("child 1 not widget")
            }
        }
