//! Theming system for StratoUI

use strato_core::types::{Color, Shadow};
// Removed unused strato_core::layout::EdgeInsets import
    ...
    fn default() -> Self {
        Self {
            sm: Shadow::new(
                ...
                strato_core::types::Point::new(0.0, 1.0),
                2.0,
                0.0,
            ),
            md: Shadow::new(
                Color::rgba(0.0, 0.0, 0.0, 0.15),
                strato_core::types::Point::new(0.0, 2.0),
                4.0,
                0.0,
            ),
            lg: Shadow::new(
                Color::rgba(0.0, 0.0, 0.0, 0.2),
                strato_core::types::Point::new(0.0, 4.0),
                8.0,
                0.0,
            ),
            xl: Shadow::new(
                Color::rgba(0.0, 0.0, 0.0, 0.25),
                strato_core::types::Point::new(0.0, 8.0),
                16.0,
                0.0,
            ),
        }
