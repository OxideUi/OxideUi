...
impl Default for LoggingConfig {
    fn default() -> Self {
        StratoConfig::default().logging
    }
}

impl Default for PerformanceConfig {
    fn default() -> Self {
        StratoConfig::default().performance
    }
}

impl Default for DebugConfig {
    fn default() -> Self {
        StratoConfig::default().debug
    }
}

/// Global configuration manager
pub struct ConfigManager {
    config: Arc<RwLock<StratoConfig>>,
}
...
pub fn init_config_with(config: StratoConfig) -> &'static ConfigManager {
