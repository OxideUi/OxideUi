...
pub struct PluginMetadata {
    ...
    /// Minimum OxideUI version required
    pub min_oxide_version: String,
    /// Plugin capabilities
...
macro_rules! plugin_metadata {
    (
        ...
        $(min_oxide_version: $min_version:expr,)?
        ...
        $crate::plugin::PluginMetadata {
            ...
            min_oxide_version: plugin_metadata!(@min_version $($min_version)?).to_string(),
        ...
        fn new(name: &str) -> Self {
            Self {
                metadata: PluginMetadata {
                    ...
                    dependencies: vec![],
                    min_oxide_version: "0.1.0".to_string(),
