...
impl Default for WindowConfig {
    fn default() -> Self {
        Self {
            title: "OxideUI Window".to_string(),
...
pub trait Window: Send + Sync {
    ...
    /// Set window title
    fn set_title(&mut self, title: &str) -> OxideResult<()>;
    
    /// Set window size
    fn set_size(&mut self, size: Size) -> OxideResult<()>;
    
    /// Set window position
    fn set_position(&mut self, position: Point) -> OxideResult<()>;
    
    /// Set window state
    fn set_state(&mut self, state: WindowState) -> OxideResult<()>;
    
    /// Set window visibility
    fn set_visible(&mut self, visible: bool) -> OxideResult<()>;
    
    /// Focus the window
    fn focus(&mut self) -> OxideResult<()>;
    
    /// Close the window
    fn close(&mut self) -> OxideResult<()>;
    ...
    fn set_theme(&mut self, theme: WindowTheme) -> OxideResult<()>;
    
    /// Get the current cursor position relative to the window
    fn cursor_position(&self) -> Option<Point>;
    
    /// Set the cursor icon
    fn set_cursor_icon(&mut self, icon: CursorIcon) -> OxideResult<()>;
    
    /// Set the cursor visibility
    fn set_cursor_visible(&mut self, visible: bool) -> OxideResult<()>;
}
...
impl WindowManager {
    ...
    /// Create a new window
    pub fn create_window(&mut self, builder: WindowBuilder) -> OxideResult<WindowId> {
    ...
    /// Close a window
    pub fn close_window(&mut self, id: WindowId) -> OxideResult<()> {
    ...
    pub fn set_active_window(&mut self, id: WindowId) -> OxideResult<()> {
    ...
    pub fn handle_event(&mut self, window_id: WindowId, event: &Event) -> OxideResult<()> {
    ...
    /// Update all windows
    pub fn update(&mut self) -> OxideResult<()> {
...
mod tests {
    ...
    fn test_window_config_default() {
        ...
        assert_eq!(config.title, "OxideUI Window");
    ...
    fn test_window_properties_default() {
        ...
        assert_eq!(props.title, "OxideUI Window");
