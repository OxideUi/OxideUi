...
use strato_ui::ui_components::components::{Coords, UiComponentStyles};
use strato_ui::ui_components::segmented_control::{
    LabelConfig, RenderableOptionConfig, SegmentedControl, SegmentedControlEvent,
};
use strato_ui::SingletonEntity as _;
use strato_ui::{AppContext, Element, Entity, TypedActionView, View, ViewContext, ViewHandle};
