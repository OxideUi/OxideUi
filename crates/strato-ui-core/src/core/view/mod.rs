...
/// itself, a process that produces a tree of rendering primitives (in [`strato_ui`](crate),
...
///
/// ```
/// # use strato_ui_core::{*, elements::Rect};
///
/// struct MyView {}
///
...
pub trait TypedActionView {
    ...
    /// If your Action enum has tons of actions, and only some of them are meaningful, you can use helper implementations from the `strato_ui::accessibility` (like `ActionAccessibilityContent::Default()` or `ActionAccessibility_content::from_debug()`).
